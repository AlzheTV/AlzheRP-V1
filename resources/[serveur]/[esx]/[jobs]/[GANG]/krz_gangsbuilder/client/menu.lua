...
mainGangMenu = NativeUI.CreateMenu('Création de gangs', 'Actions', nil, nil, nil, nil, nil, 180, 0, 0)
...
function DrawGangMenu()
	...
	local weaponsItem = NativeUI.CreateListItem('Kit VIDE !', {'Kit Normal', 'Kit Vide'}, 1, '')
