...
function OpenCustomersMenu()
	ESX.TriggerServerCallback('esx_banquierjob:getCustomers', function(customers)
		local elements = {
			...
			if data.value == 'deposit' then
				...
				ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'customer_deposit_amount', {
					...
					if amount == nil then
						...
						TriggerServerEvent('esx_banquierjob:customerDeposit', customer.source, amount)
			...
			elseif data.value == 'withdraw' then
				...
				ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'customer_withdraw_amount', {
					...
					if amount == nil then
						...
						TriggerServerEvent('esx_banquierjob:customerWithdraw', customer.source, amount)
						OpenCustomersMenu()
					end
				end, function(data2, menu2)
					menu2.close()
...
AddEventHandler('esx_banquierjob:hasEnteredMarker', function (zone)
	if zone == 'BankActions' and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'banquier' then
		CurrentAction     = 'bank_actions_menu'
		CurrentActionMsg  = _U('press_input_context_to_open_menu')
		CurrentActionData = {}
	end
...
AddEventHandler('esx_banquierjob:hasExitedMarker', function (zone)
	CurrentAction = nil
	ESX.UI.Menu.CloseAll()
end)
...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(Config.Zones) do
			if(ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'banquier' and v.Type ~= -1 and GetDistanceBetweenCoords(coords, v.Pos.x, v.Pos.y, v.Pos.z, true) < Config.DrawDistance) then
...
Citizen.CreateThread(function()
	while true do
		...
		if(ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'banquier') then
			local coords      = GetEntityCoords(PlayerPedId())
			local isInMarker  = false
			...
			if isInMarker and not hasAlreadyEnteredMarker then
				...
				TriggerEvent('esx_banquierjob:hasEnteredMarker', currentZone)
			end

			if not isInMarker and hasAlreadyEnteredMarker then
				hasAlreadyEnteredMarker = false
				TriggerEvent('esx_banquierjob:hasExitedMarker', lastZone)
			end
		end
...
function IsJobTrue()
    if PlayerData ~= nil then
        local IsJobTrue = false
        if PlayerData.job ~= nil and PlayerData.job.name == 'banquier' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('banquier_outfit'),    value = 'banquier_outfit'},
  }
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'banquier_outfit' then
		TriggerServerEvent("player:serviceOn", "banquier")
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'banquier', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'banquier_actions',
    {
	  css =  'job',
      title    = _U('banquier'),
      align    = 'top-left',
        ...
        ESX.UI.Menu.Open(
						'default', GetCurrentResourceName(), 'menu_gps',
						{
							...
							elements = {
								...
								{label = 'Récolte Billet', value = 'menu_gps_billet'},
						...
						function(data2, menu2)
							...
							if data2.current.value == 'menu_gps_entreprise' then
								...
								ESX.ShowNotification("~b~Destination ajouté au GPS !")
							end

							if data2.current.value == 'menu_gps_billet' then
								SetNewWaypoint( 2705.128, 3454.310, 55.109 )
								local source = GetPlayerServerId();
								ESX.ShowNotification("~b~Destination ajouté au GPS !")
							end

							if data2.current.value == 'menu_gps_billet2' then
								SetNewWaypoint( 267.952, 270.665, 102.134 )
								local source = GetPlayerServerId();
								ESX.ShowNotification("~b~Destination ajouté au GPS !")
							end
...
RegisterNetEvent('esx_banquierjob:announce')
AddEventHandler('esx_banquierjob:announce', function(text)
 	texteafiche = text
    affichenews = true
end)

RegisterNetEvent('esx_banquierjob:announcestop')
AddEventHandler('esx_banquierjob:announcestop', function()
    affichenews = false
    Wait(6)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_banquier', _U('billing'), amount)
        end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_banquierjob:getStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_banquierjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_banquierjob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_banquierjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_banquierjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_banquierjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_banquierjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_banquierjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
AddEventHandler('esx_banquierjob:hasExitedMarker', function(zone)
	...
	TriggerServerEvent('esx_banquierjob:stopHarvestBil')
    TriggerServerEvent('esx_banquierjob:stopSellBil')
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and (ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'banquier') then
		...
		if CurrentAction == 'bil_harvest' then
            TriggerServerEvent('esx_banquierjob:startHarvestBil')
        end

		if CurrentAction == 'bil_resell' then
            TriggerServerEvent('esx_banquierjob:startSellBil')
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'banquier', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'banquier')
            end
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(0,  Keys['F6']) and (ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'banquier') and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'banquier_actions') then
