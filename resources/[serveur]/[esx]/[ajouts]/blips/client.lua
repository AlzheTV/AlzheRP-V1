...
AddEventHandler('mostraBlips', function()
    ...
    if mostrablip then
        ...
        TriggerEvent('chatMessage', 'Blips ', {0, 255, 0}, "activés.")
    else
        mostrablip = false
        -- notifica blips disabilitati
        TriggerEvent('chatMessage', 'Blips ', {255, 0, 0}, "désactivés.")
    end
end)
...
AddEventHandler('mostraNomi', function()
    ...
    if mostranomi then
        mostranomi = true
        -- notifica blips abilitati
        TriggerEvent('chatMessage', 'Names ', {0, 255, 0}, "activés.")
    else
        mostranomi = false
        -- notifica blips disabilitati
        TriggerEvent('chatMessage', 'Names ', {255, 0, 0}, "désactivés.")
    end
end)
