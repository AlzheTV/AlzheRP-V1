...
function OpenCloakroomMenu()
  ...
  if Config.EnableNonFreemodePeds then
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'bodyguard_wear' then
        ...
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          ...
          if skin.sex == 0 then
			    ...
			    SetPedComponentVariation(GetPlayerPed(-1), 3, 30, 0, 0) -- Main
			    SetPedComponentVariation(GetPlayerPed(-1), 11, 53, 0, 0) -- Veste
			    SetPedComponentVariation(GetPlayerPed(-1), 4, 24, 0, 0) -- Jeans
