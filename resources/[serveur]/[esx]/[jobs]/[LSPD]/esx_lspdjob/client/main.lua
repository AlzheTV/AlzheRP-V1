...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = 'CADET - Tenue LSPD', value = 'tenu_lspd' },
		{ label = 'Officier - Tenue LSPD', value = 'tenu_ma' },
		{ label = 'Lieutenant - Tenue LSPD', value = 'tenu_hiv'},
		{ label = 'SWAT - Léger', value = 'tenu_swat'},
		{ label = 'SWAT - Lourd', value = 'tenu_swatgr'},
		{ label = 'Tenue Capitiane', value = 'tenu_doag' },
	}
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = '<span style="color:669999;">Status<span style="color:cyan;"> >', value = 'status'},
			{label = '<span style="color:#669999;">Intéractions Citoyen<span style="color:cyan;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:#669999;">Intréactions Menottes<span style="color:cyan;"> >', value = 'menu_menottes'},
			{label = '<span style="color:#669999;">Intéractions Véhicules<span style="color:cyan;"> >', value = 'vehicle_interaction'},
			{label = '<span style="color:#669999;">Intéractions Objets<span style="color:cyan;"> >', value = 'object_spawner'},
			{label = '<span style="color:#669999;">Équipement LSPD<span style="color:cyan;"> >', value = 'lspd_equipement'},
			{label = '<span style="color:#669999;">Amender le citoyen<span style="color:cyan;"> >', value = 'ammende'},
			{label = '<span style="color:#669999;">Intéractions LSPD<span style="color:cyan;"> >', value = 'renfort'}
	}}, function(data, menu)
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						...
						if distance <= 2.0 then
							...
							ESX.ShowNotification('Rapprochez-vous.')
						end
		...
		elseif data.current.value == 'menu_menottes' then
			...
			local elements = {
				{label = '<span style="color:green;">Mettre les menottes', value = 'handcuff'},
				{label = '<span style="color:red;">Retirer les menottes', value = 'handcuff2'},
				{label = 'Escorter la personne', value = 'drag'},
				{label = '<span style="color:green;">Mettre dans le véhicule', value = 'put_in_vehicle'},
				{label = '<span style="color:red;">Sortir du véhicule', value = 'out_the_vehicle'}
			}
		...
		elseif data.current.value == 'status' then
			...
			local elements = {
				{label = '<span style="color:green;">10-8 - Prise de service', value = 'prise'},
				{label = '<span style="color:red;">10-10 - Fin de service', value = 'fin'},
				{label = '<span style="color:orange;">10-6 Pause de service', value = 'pause'},
				{label = '<span style="color:orange;">10-12 Standby - En attente de dispatch', value = 'standby'},
				{label = '<span style="color:orange;">10-48 Contrôle routier en cours', value = 'control'},
				{label = '<span style="color:orange;">10-30 Refus d\'obtempérer - délit de fuite', value = 'refus'},
				{label = '<span style="color:orange;">10-31 Arrestation en cours', value = 'arrestation'}
			}
		...
		elseif data.current.value == 'renfort' then
			...
			table.insert(elements, {label = ('CODE 2 - RENFORT NORMAUX'), value = 'petite_demande'})
			table.insert(elements, {label = ('CODE 3 - RENFORT IMPORTANTS'), value = 'demande_importante'})
			table.insert(elements, {label = ('CODE 99 - TOUTES UNITÉS DEMANDÉES'), value = 'omgad'})
		...
		elseif data.current.value == 'lspd_equipement' then
			...
			if grade == 'recruit' then
				table.insert(elements, {label = ('Équipement de cadet'), value = 'equipement_cadet'})
			elseif grade == 'officer' then
				table.insert(elements, {label = ('Équipement d\'officier'), value = 'equipement_officier'})
			elseif grade == 'sergeant' then
				table.insert(elements, {label = ('Équipement de sergent'), value = 'equipement_sergeant'})
			elseif grade == 'lieutenant' then
				table.insert(elements, {label = ('Équipement de lieutenant'), value = 'equipement_lieutenant'})
			elseif grade == 'boss' then 
				table.insert(elements, {label = ('Équipement de capitaine'), value = 'equipement_cmd'})
			end
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'lspd_equipement', {
				...
				if action == 'equipement_cadet' then
					...
					ESX.ShowAdvancedNotification('LSPD INFO', 'Armurie LSPD', 'Voici ton équipement. Il est tracé.', 'CHAR_AMMUNATION', 1)
...
AddEventHandler('renfort:setBlip', function(coords, raison)
	if raison == 'petit' then
		...
		ESX.ShowAdvancedNotification('CENTRALE LSPD', '~b~Demande de renforts', 'Renforts demandés.\nRéponse: ~g~CODE-2\n~w~Importance: ~g~Normale.', 'CHAR_CALL911', 8)
		Wait(1000)
	...
	elseif raison == 'importante' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		PlaySoundFrontend(-1, "OOB_Start", "GTAO_FM_Events_Soundset", 1)
		ESX.ShowAdvancedNotification('CENTRALE LSPD', '~b~Demande de renforts', 'Renfort demandés.\nRéponse: ~g~CODE-3\n~w~Importance: ~o~Importante.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
		color = 47
	elseif raison == 'omgad' then
		...
		ESX.ShowAdvancedNotification('CENTRALE LSPD', '~b~Demande de renfort', 'Renforts demandés.\nRéponse: ~g~CODE-99\n~w~Importance: ~r~URGENTE !', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	...
	BeginTextCommandSetBlipName("STRING")
	AddTextComponentString('~r~Renforts demandés !')
